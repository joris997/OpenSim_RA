...
Interpolate::Interpolate(OpenSim::GeometryPath const& gp,
...
Interpolate::Interpolate(OpenSim::GeometryPath const& pbp,
...
double Interpolate::getInterpDerFunc(const std::vector<double>& x, int coordinate){
    // get the index of the closest range value to the discretization point
    for (int i=0; i<dimension; i++){
        auto it = std::find_if(std::begin(discretization[i]),
                               std::end(discretization[i]),
    ...
    for (int i=0; i<4; i++){
        ...
        z += getEval()*Beta/(dS[coordinate].gridsize);
...
//void Interpolate::printContent(){
//    std::ofstream printFile;
//    printFile.open("FBP.xml");
//    printFile << "1" << "\n";
//    printFile << "\n";
//    printFile << dimension << "\n";
//    printFile << "\n";
...
//void Interpolate::readContent(){
//    std::ifstream readFile;
//    readFile.open("FBP.xml",std::ios::in);
//    if (readFile){
//        std::string sLine;
//        // get identity
...
//            }
//            std::cout << sLine << "\n";
//            std::cout << atof(sLine.c_str()) << std::endl;
//        }
//        // get dimension
//        while(std::getline(readFile,sLine)){
//            if (sLine == ""){
...
//            size_t last = 0;
//            size_t next = 0;
//            while ((next = sLine.find(delimiter,last)) != std::string::npos){
//                std::cout << sLine.substr(last,next-last) << std::endl;
//                last = next + 1;
//            }
//            std::cout << sLine.substr(last) << std::endl;
//        }
